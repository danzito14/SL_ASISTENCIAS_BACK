...
class Settings(BaseSettings):
    # PostgreSQL — tenancy se conecta como svc_tenancy (dueño de empresas/áreas/
    ...
    APP_TITLE:   str = "Tenancy Service"
    APP_VERSION: str = "1.0.0"
    DEBUG:       bool = False
    CORS_ORIGINS: str = ""

    # JWT — tenancy NO emite tokens; valida (stateless) el que emite identity.
