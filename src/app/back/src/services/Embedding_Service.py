...
class EmbeddingService:
    ...
    def listar(
        ...
        trabajadores.id_empresa (denormalizado) salvo que id_empresa sea None
        (super-admin → todas). Sin 'id_area' trae todas las áreas de la empresa.
        """
    ...
    def empresa_de_trabajador(self, id_trabajador: int, db: Session) -> int | None:
        """Empresa de un trabajador (id_empresa denormalizado en trabajadores)."""
        fila = (
    ...
    def empresa_de_embedding(self, id_embedding: int, db: Session) -> int | None:
        """Empresa de un embedding (Embedding → Trabajador.id_empresa denormalizado)."""
        fila = (
            db.query(Trabajador.id_empresa)
    ...
    def reemplazar_vector_por_trabajador(self, id_trabajador: int, cara: dict, db: Session) -> Embedding:
        ...
        Args:
            cara: dict devuelto por recognition_service.detectar_y_extraer(...).
        """
