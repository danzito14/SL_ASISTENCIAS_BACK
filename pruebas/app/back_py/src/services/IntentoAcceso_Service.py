...
class IntentoAccesoService:
    ...
    def obtener(self, id_intento: int, db: Session) -> IntentoAcceso:
    ...
    def empresa_de_intento(self, id_intento: int, db: Session) -> int | None:
    ...
    def ruta_archivo_foto(self, id_intento: int, db: Session) -> str | None:
        """
